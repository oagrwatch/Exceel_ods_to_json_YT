...
if uploaded_file is not None:
    try:
        ...
        for _, row in df.iterrows():
            ...
            # Description - μόνο αν υπάρχει πραγματική τιμή
        ...
        # Δημιουργία JSON με custom formatting για να ταιριάζει με το format σου
        json_lines = ["["]
        
        for idx, rec in enumerate(records):
            json_lines.append(" {")
            
            # Παίρνουμε τα keys με τη σειρά που ορίσαμε
            items = []
            ...
            # Προσθέτουμε τυχόν extra columns που δεν ήταν στο output_order
            for key in rec:
